...
namespace Example
{
    public class GetSecurityPriceTechnicalsSmaExample
    {
        ...
        public static void Main()
        {
            ...
            var period = 5;  // int? | The number of observations, per period, to calculate Simple Moving Average (optional)  (default to 20)
            ...
            Console.WriteLine(realtimePrice.LastPrice);
